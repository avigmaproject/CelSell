...
export const API = {
  ...
  ACTIVE_PROFILE: '/api/cssell/DeleteUserMasterData',
  DELETE_PROFILE: '/api/cssell/DeleteUserMasterData',
  ...
  GET_VENDOR_MASTER_DATA: '/api/cssell/GetVendorMaster',
  GET_COLOR_DATA: '/api/cssell/GetColourMaster',
  GET_SEARCH_DATA: '/api/cssell/GetSearchData',
  GET_PDF: '/api/cssell/ExportDataInPdf',
  GET_CSV: '/api/cssell/ExportDataInExcel',
};
